...
<imageEmbed image={{ src: "/img/landing-assets/tinacms-github-integration.jpg", alt: "Diagram showing TinaCMS integration with GitHub for content storage and version control", width: 3200, height: 1800 }} caption="Keep everything in GitHub" />
