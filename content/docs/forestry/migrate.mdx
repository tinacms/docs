...
<Callout
  variant="warning"
  body={<>
    This TinaCMS Migration will change your site's content files. Please back up your site's content before proceeding. This is best done by doing a git commit before proceeding.
  </>}
/>
...
<Callout
  variant="idea"
  body={<>
    If you have Netlify or Vercel previews set up, you can even edit on `&lt;your-preview-url&gt;/admin`.
  </>}
/>
