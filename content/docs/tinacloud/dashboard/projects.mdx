...
<fileStructure
  fileStructure={[
    { id: "tp-projects", name: "projects", type: "folder", parentId: null },
    { id: "tp-northwind", name: "northwind-docs", type: "folder", parentId: "tp-projects" },
    { id: "tp-northwind-tina", name: "tina", type: "folder", parentId: "tp-northwind" },
    { id: "tp-config", name: "config.ts", type: "file", parentId: "tp-northwind-tina" },
    { id: "tp-generated", name: "__generated__", type: "folder", parentId: "tp-northwind-tina" },
    { id: "tp-cat-photos", name: "cat-photos", type: "folder", parentId: "tp-projects" }
  ]}
/>
...
<Callout variant="lock"
  body={<>
    API tokens should be considered sensitive and not be committed to your project repository. Content tokens allow clients read-only access to your repository content. Search tokens allow clients to update the TinaCloud hosted search index for your site. Please use environment variables for these in your Tina configuration.
  </>}
/>
