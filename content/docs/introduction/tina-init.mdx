...
<Callout
  variant="info"
  body={<>
    This doc assumes that you have a working site. If not, you can quickly get started with our default [Astro starter](/docs/frameworks/astro/), or one of the [other starters](/docs/introduction/using-starter/) in the CLI.
  </>}
/>
