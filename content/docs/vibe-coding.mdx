...
<imageEmbed image={{ src: "/setup.png", alt: "" }} caption="Results of the above prompt" />
...
<Callout variant="idea"
  body={<>
    Check out [SSW's Rules to Better AI Development](https://www.ssw.com.au/rules/rules-to-better-ai-development/)
  </>}
/>
...
<Callout variant="idea"
  body={<>
    To learn how to make a great AGENTS.md file read the SSW Rule [Write an AGENTS.md](https://www.ssw.com.au/rules/write-agents-md)
  </>}
/>
...
<imageEmbed image={{ src: "/vibe_cycle.png", alt: "" }} caption="The Vibe Coding Cycle" />
