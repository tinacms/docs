  ...
  property={[
    {
      name: "hasNextPage",
      type: "boolean",
      description: "During forward pagination, indicates if another page of results is available.\n"
    },
    {
      name: "hasPreviousPage",
      type: "boolean",
      description: "During reverse pagination, indicates if another page of results is available.\n"
    },
    {
      name: "startCursor",
      type: "string",
