...
<typeDefinition
  property={[
    ...
    },
    {
      name: "path",
      type: "String!",
      description: "The full path of the file relative to the project root\n"
    },
    {
      name: "breadcrumbs",
      type: "[String!]!",
      description: "An array of the parent folders of the file\n"
    },
    {
      name: "relativePath",
      type: "String!",
      description: "The path of the file relative to the collection path\n"
    },
    {
      name: "extension",
      type: "String!",
    ...
    },
    {
      name: "template",
      type: "String!",
      description: "The template of the document (or the name of the collection if not using `templates`)\n"
    },
    {
      name: "collection",
      type: "Collection!",
