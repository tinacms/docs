...
<Callout variant="info"
  body={<>
    This approach is not officially supported by the core team. It reflects how some teams are currently achieving grouped content and media. Use at your own discretion.
  </>}
/>
...
<fileStructure
  fileStructure={[
    { id: "smc-public", name: "public", type: "folder", parentId: null },
    { id: "smc-uploads", name: "uploads", type: "folder", parentId: "smc-public" },
    { id: "smc-posts", name: "posts", type: "folder", parentId: "smc-uploads" },
    { id: "smc-post-a", name: "post-a", type: "folder", parentId: "smc-posts" },
    { id: "smc-index", name: "index.md", type: "file", parentId: "smc-post-a" },
    { id: "smc-image", name: "image.png", type: "file", parentId: "smc-post-a" }
  ]}
/>

<Callout variant="info"
  body={<>
    `public/uploads` is the default Media folder, you can change it to be whatever suits your project.\
