...
<imageEmbed image={{ src: "/img/docs/converting-md-to-mdx/nice-email-template.png", alt: "Rendered email template with To, Cc, Bcc, and Subject fields above a sample greeting" }} caption="Rendered email template" />
