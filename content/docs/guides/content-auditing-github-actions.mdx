...
<Callout variant="info"
  body={<>
    This is still a work in progress, It is functional but we are working on making it simpler. Keep an eye out for updates [here](https://github.com/tinacms/tinacms/issues/6156).
  </>}
/>
...
<propertyTable
  property={[
    {
      name: "TINA_TOKEN",
      description: "Your TinaCloud API Token. **TinaCloud | \\<your-project> | Tokens | Content (Readonly)**\n",
      required: true
    },
    {
      name: "TINA_CLIENT_ID",
      description: "The TinaCMS Client ID for your project. You can find it in **TinaCloud | Projects | \\<your-project> | ⚙️ Project Details | Client ID**\n",
      required: true
    }
  ]}
/>
...
<propertyTable
  property={[
    {
      name: "TINA_AUDITOR_CONTENT_WINDOW",
      description: "A number indicating how many outdated content items will be checked when you run the action. (e.g. 5)\n",
      required: true
    },
    {
      name: "TINA_AUDITOR_EXPIRY_DAYS",
      description: "The number of days that will pass before your content is re-evaluated being checked.\n",
      required: true
    },
    {
      name: "TINA_AUDITOR_SYSTEM_PROMPT",
      description: "The prompt that will be used to evaluate your content when passing it to GitHub model.\n"
    },
    {
      name: "TINA_AUDITOR_COLLECTION",
      description: "The collection the audit query will be ran against.\n",
      required: true
    }
  ]}
/>
