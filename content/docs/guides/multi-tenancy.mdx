...
<fileStructure
  fileStructure={[
    { id: "mt1-app", name: "app", type: "folder", parentId: null },
    { id: "mt1-tenant", name: "[tenant]", type: "folder", parentId: "mt1-app" },
    { id: "mt1-slug", name: "[slug]", type: "folder", parentId: "mt1-tenant" },
    { id: "mt1-page", name: "page.tsx", type: "file", parentId: "mt1-slug" }
  ]}
/>
...
<fileStructure
  fileStructure={[
    { id: "mt2-content", name: "content", type: "folder", parentId: null },
    { id: "mt2-docs", name: "docs", type: "folder", parentId: "mt2-content" },
    { id: "mt2-tenant1", name: "tenant1", type: "folder", parentId: "mt2-docs" },
    { id: "mt2-tenant1-intro", name: "intro.mdx", type: "file", parentId: "mt2-tenant1" },
    { id: "mt2-tenant2", name: "tenant2", type: "folder", parentId: "mt2-docs" },
    { id: "mt2-tenant2-intro", name: "intro.mdx", type: "file", parentId: "mt2-tenant2" }
  ]}
/>
