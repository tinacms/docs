  ...
  property={[
    {
      name: "component",
      type: "'group'",
      description: "The name of the plugin component. Always `'group'`\n",
      required: true
    },
    {
      name: "name",
    ...
    },
    {
      name: "fields",
      type: "Field[]",
      description: "An array of [`Field`](/docs/reference/toolkit/fields) values that will render as a sub-menu.\n",
      required: true
    },
    {
      name: "label",
