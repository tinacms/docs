  ...
  property={[
    {
      name: "component",
      type: "'list'",
      description: "The name of the plugin component. Always `'list'`.\n",
      required: true
    },
    {
      name: "name",
    ...
    {
      name: "field",
      type: "{ component: 'text' | 'textarea' | 'number' | 'select' }",
      description: "The [`field`](/docs/reference/toolkit/fields) that will render to edit each list item. Component Options: 'text', 'textarea', 'number', or 'select'\n",
      required: true
    },
    {
      name: "label",
    ...
    },
    {
      ...
      description: "Provides the `list` items with default data upon being created. Returns an empty string if no value is provided.\n"
    },
    {
      name: "itemProps",
      type: "(item: object) => { key?: string }",
