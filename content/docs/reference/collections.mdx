...
<imageEmbed image={{ src: "/img/docs/reference/global-collections.png", alt: "Global collections (Global, SEO Defaults, Announcement Bar) listed under the Site heading in the TinaCMS sidebar, each with a globe icon, separate from the regular Collections list above." }} caption="Global collections (Global, SEO Defaults, Announcement Bar) listed under the Site heading in the TinaCMS sidebar, each with a globe icon, separate from the regular Collections list above." />
