  ...
  property={[
    {
      ...
      description: "This is used to save content to Git. It is called whenever a value is saved in the CMS.\n",
      required: true
    },
    {
      name: "onDelete",
      type: "(key: string) => Promise<void>",
      description: "This is used to delete content from Git. It is called whenever a value is deleted in the CMS.\n",
      required: true
    }
  ]}
/>
