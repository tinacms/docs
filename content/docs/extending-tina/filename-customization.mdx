...
<propertyTable
  property={[
    {
      name: "ui.filename.readonly",
      type: "boolean",
      description: "Prevents the user from editing the filename\n"
    },
    {
      name: "ui.filename.slugify",
      type: "(values, meta) => string",
      description: "A function that generates the filename based on form values\n"
    },
    {
      name: "ui.filename.parse",
      type: "(filename) => string",
      description: "A function that sanitizes the filename input as the user types\n"
    }
  ]}
/>
