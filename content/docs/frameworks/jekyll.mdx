  ...
  cards={[
    {
      ...
      description: "Similar static site generator",
      link: "/docs/frameworks/hugo/",
      linkText: "Read more"
    },
    {
      title: "11ty setup guide",
      description: "Another popular SSG option",
      link: "/docs/frameworks/11ty/",
      linkText: "Read more"
    },
    {
      title: "Next.js setup guide",
      description: "For React-based sites",
