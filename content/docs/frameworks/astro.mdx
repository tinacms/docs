  ...
  cards={[
    {
      ...
      description: "the integration, per-island refetch, and custom MDX embeds",
      link: "/docs/contextual-editing/astro/",
      linkText: "Read more"
    },
    {
      title: "Deploy to Cloudflare Workers",
      description: "the starter auto-detects the host and keeps visual editing working at request time",
      link: "/docs/tinacloud/deployment-options/cloudflare-workers",
      linkText: "Read more"
    },
    {
      title: "Migrating from React-based Visual Editing",
      description: "existing sites on the old `client:tina` path",
      link: "/docs/migrations/astro-react-free-visual-editing/",
      linkText: "Read more"
    },
    {
...
<cardGrid
  cards={[
    ...
    },
    {
      ...
      description: "Using TinaCMS with Hugo",
      link: "/docs/frameworks/hugo/",
      linkText: "Read more"
    },
    {
      title: "Self-hosting options",
      description: "Host TinaCMS on your own infrastructure",
      link: "/docs/self-hosted/overview/",
      linkText: "Read more"
    }
  ]}
/>
