...
<imageEmbed image={{ src: "/fetch-option-1.png", alt: "" }} caption="Flow when an existing page is requested" />

<imageEmbed image={{ src: "/fetch-option-2.png", alt: "" }} caption="Flow when a new page is requested" />
