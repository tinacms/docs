...
<Callout variant="idea"
  body={<>
    If you are getting errors when running this command, please see the [Common Errors](/docs/forestry/common-errors) page.
  </>}
/>
...
<fileStructure
  fileStructure={[
    { id: "ar-content", name: "content", type: "folder", parentId: null },
    { id: "ar-posts", name: "posts", type: "folder", parentId: "ar-content" },
    { id: "ar-hello-world", name: "hello-world.md", type: "file", parentId: "ar-posts" }
  ]}
/>
...
<cardGrid
  cards={[
    {
      title: "Check out the content modeling docs",
      description: "Content Modeling with TinaCMS",
      link: "/docs/schema/",
      linkText: "Check out"
    },
    {
      title: "Learn how to query your content",
      description: "Content API Overview",
      link: "/docs/features/data-fetching/",
      linkText: "Learn"
    },
    {
      title: "Deploy Your Site",
      description: "What is TinaCloud?",
      link: "/docs/tinacloud",
      linkText: "Deploy"
    }
  ]}
  ...
  cards={[
    {
      ...
      description: "Alternative routing approach",
      link: "/docs/frameworks/next/pages-router/",
      linkText: "Read more"
    },
    {
    ...
    {
      title: "Other framework guides",
      description: "Astro, Hugo, Gatsby, and more",
