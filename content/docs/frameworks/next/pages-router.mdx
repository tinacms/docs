...
<fileStructure
  fileStructure={[
    { id: "pr-content", name: "content", type: "folder", parentId: null },
    { id: "pr-posts", name: "posts", type: "folder", parentId: "pr-content" },
    { id: "pr-hello-world", name: "hello-world.md", type: "file", parentId: "pr-posts" }
  ]}
/>
  ...
  cards={[
    {
      ...
      description: "Modern routing with React Server Components",
