...
<Callout variant="info"
  body={<>
    This is a Next.js example, but you can use TinaCMS with any framework.
  </>}
/>
...
<Callout variant="info"
  body={<>
    Some features are not available when self-hosting TinaCMS. See the [Self-hosted Limitations](/docs/introduction/faq#what-features-are-unavailable-in-self-hosted-tina-compared-to-tinacloud) section for more info.
  </>}
/>
...
<cardGrid
  cards={[
    {
      title: "TinaCloud",
      description: "Managed hosting alternative",
      link: "/docs/tinacloud/",
      linkText: "Read more"
    },
    {
      title: "Deployment Options",
      description: "Deploy to Vercel, Netlify, or other providers",
      link: "/docs/tinacloud/deployment-options/vercel/",
      linkText: "Read more"
    },
    {
      title: "Media Storage",
      description: "Configure media handling for self-hosted setups",
      link: "/docs/reference/media/overview/",
      linkText: "Read more"
    }
  ]}
/>
