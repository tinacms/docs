...
async function createPullRequest() {
  try {
    ...
    const prBody = `This PR contains Chinese translations for the documentation files updated in PR (${SERVER_URL}/${REPO}/pull/${PR_NUMBER}). 🤖 This PR was automatically generated by the translation workflow.`;
